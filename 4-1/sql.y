...
insert_stmt:
    ...
    opt_onupdate { emit("INSERTVALS %d %d %s", $2, $7, $4); free($4);   }
|   INSERT insert_opts opt_into NAME
    SET insert_asgn_list
    opt_onupdate { emit("INSERTASGN %d %d %s", $2, $6, $4); free($4);   }
...
replace_stmt:
    ...
    opt_col_names
    VALUES insert_vals_list
    opt_onupdate { emit("REPLACEVALS %d %d %s", $2, $7, $4); free($4);   }
|   REPLACE insert_opts opt_into NAME
    SET insert_asgn_list
    opt_onupdate { emit("REPLACEASGN %d %d %s", $2, $6, $4); free($4);   }
|   REPLACE insert_opts opt_into NAME opt_col_names
    select_stmt
    opt_onupdate { emit("REPLACESELECT %d %s", $2, $4); free($4);        };
